...
class A {
  ...
  A(int val = 1) { myInt1 = myInt2 = myLong1 = myLong2 = 1; }
...
int main() {
  // Demos is_trivially_copyable
  {
    ...
    std::cout << "is_trivially_copyable: " << is_trivially_copyable
              << std::endl;
...

  {
    ...
    std::cout << "atomic_x: " << atomic_x << ", y: " << y << ", z: " << z
              << std::endl;
  }
  // exchange
  std::cout << "Exchange with atomic: " << std::endl;
  {
    ...
    std::cout << "atomic_x: " << atomic_x << ", atomic_y: " << atomic_y
              << ", z: " << z << std::endl;
  }
  // exchange
  {
    ...
    std::cout << "success: " << success << ", atomic_x: " << atomic_x
  ...
  // Exchange:
  {
    ...
    int y_int = 2;
    std::cout << "Before: x_int: " << x_int << ", y_int: " << y_int
              << std::endl;
    // Exchange is equivalent to: z=x, x=y
    int z_int = x_int.exchange(y_int);
    std::cout << "After: x_int: " << x_int << ", y_int: " << y_int
