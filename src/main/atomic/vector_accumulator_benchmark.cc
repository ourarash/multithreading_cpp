...
static void BM_AtomicAccumulator(benchmark::State& state) {
  for (auto _ : state) {
    ...
    VectorAccumulator::Driver(d.v, number_of_threads,
                              VectorAccumulator::AtomicAccumulator);
  }
}
//-----------------------------------------------------
...
static void BM_AtomicAccumulatorRelaxed(benchmark::State& state) {
  for (auto _ : state) {
    ...
    VectorAccumulator::Driver(d.v, number_of_threads,
                              VectorAccumulator::AtomicAccumulatorRelaxed);
  }
}
//-----------------------------------------------------
...
static void BM_AtomicAccumulatorPartitionRelaxed(benchmark::State& state) {
  for (auto _ : state) {
    ...
    VectorAccumulator::Driver(
        d.v, number_of_threads,
        VectorAccumulator::AtomicAccumulatorPartitionRelaxed);
  }
}
//-----------------------------------------------------
static void BM_MutexAccumulatorPartition(benchmark::State& state) {
  for (auto _ : state) {
    ...
    VectorAccumulator::Driver(d.v, number_of_threads,
                              VectorAccumulator::MutexAccumulatorPartition);
  }
}
//-----------------------------------------------------
